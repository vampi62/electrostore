...
namespace ElectrostoreAPI.Controllers
{
    ...
    public class ProjectStatusController : ControllerBase
    {
        ...
        public ProjectStatusController(IProjectStatusService projetStatusService)
        {
        ...
        public async Task<ActionResult<PaginatedResponseDto<ReadExtendedProjectStatusDto>>> GetProjetStatusByProjetId([FromRoute] int id_project, [FromQuery] int limit = 100, [FromQuery] int offset = 0,
        ...
        [Authorize(Policy = "AccessToken")]
        public async Task<ActionResult<ReadExtendedProjectStatusDto>> GetProjetStatusById([FromRoute] int id_project, [FromRoute] int id_project_status)
        {
