...
public record AiChatHistoryMessageDto
{
    ...
    [Required(ErrorMessage = "{0} is required.")]
    [MaxLength(FieldLengths.MaxChatMessageLength, ErrorMessage = "{0} cannot exceed {1} characters.")]
...
public record CreateAiChatMessageDto
{
    ...
    [FileSize(nameof(FieldLengths.MaxAudioSizeMB), ErrorMessage = "{0} cannot exceed {1} MB in size.")]
    [FileType(nameof(FieldLengths.AllowedAudioMimeTypes),
