...
export const useTagsStore = defineStore({
    ...
    actions: {
        ...
        async getTagStoreByInterval(idTag, limit = 100, offset = 0) {
        ...
        async getTagStoreById(idTag, idStore) {
        ...
        async getTagBoxByInterval(idTag, limit = 100, offset = 0) {
        ...
        async getTagBoxById(idTag, idBox) {
        ...
        async getTagItemByInterval(idTag, limit = 100, offset = 0) {
        ...
        async getTagItemById(idTag, idItem) {
