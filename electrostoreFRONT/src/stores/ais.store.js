	...
	actions: {
		...
		loadToEdition(id, preset = null) {
			...
			if (id !== "new" && this.ais[id]) {
				this.iaEdition[id] = {
					loading: false,
					name_ia: this.ais[id].name_ia,
					description_ia: this.ais[id].description_ia,
					date_ia: this.ais[id].date_ia,
					trained_ia: this.ais[id].trained_ia,
				};
			} else {
				this.iaEdition[id] = {
					loading: false,
