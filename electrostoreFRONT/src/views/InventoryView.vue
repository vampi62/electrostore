    ...
    <table class="min-w-full border-collapse border border-gray-300">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th
                    class="border border-gray-300 px-2 py-2 text-center text-sm font-medium text-gray-800 bg-gray-200 cursor-pointer relative"
                    ...
                    <tr @click="navigate" class=" transition duration-150 ease-in-out hover:bg-gray-200 cursor-pointer">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700 text-center">
                            <template v-if="item.id_img">
                                ...
                                <span v-else class="w-16 h-16 object-cover rounded">{{ $t('item.VInventoryLoading') }}</span>
                            </template>
                            <template v-else>
