...
<template>
	<div class="max-w-lg mx-auto bg-white p-6 rounded shadow">
		<h2 class="text-2xl font-bold mb-4 mr-2">{{ $t('common.VResetPasswordTitle') }}</h2>
		...
		<!-- Link to Login -->
		<div class="mt-4">
			<RouterLink to="/login" class="text-blue-500 hover:underline">{{ $t('common.VResetPasswordLoginLink') }}
			</RouterLink>
		</div>
	</div>
</template>
