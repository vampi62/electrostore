...
const filter = ref([
	...
	{ key: "price_command", value: "", type: "number", label: "commands.FilterPriceMin", compareMethod: "=ge=" },
	{ key: "price_command", value: "", type: "number", label: "commands.FilterPriceMax", compareMethod: "=le=" },
