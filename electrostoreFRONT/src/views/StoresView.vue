...
async function fetchData() {
    storesStore.getStoreByInterval(100, 0);
}
onMounted(() => {
    fetchData();
});
...
const filter = ref([
    { key: 'nom_store', value: '', type: 'text', label: 'nom', compareMethod: 'contain' },
    { key: 'mqtt_name_store', value: '', type: 'text', label: 'nom mqtt', compareMethod: 'contain' },
    { key: 'xlength_store', value: '', type: 'number', label: 'taille X maximum', compareMethod: '<=' },
    { key: 'ylength_store', value: '', type: 'number', label: 'taille Y maximum', compareMethod: '<=' }
]);
    ...
    <table class="min-w-full border-collapse border border-gray-300">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="border border-gray-300 px-2 py-2 text-center text-sm font-medium text-gray-800 bg-gray-200 cursor-pointer relative"
                    ...
                    <div class="flex justify-between items-center">
                        <span class="flex-1">xlength</span>
                ...
                <th class="border border-gray-300 px-2 py-2 text-center text-sm font-medium text-gray-800 bg-gray-200 cursor-pointer relative"
                    ...
                    <div class="flex justify-between items-center">
                        <span class="flex-1">ylength</span>
                ...
                <th class="border border-gray-300 px-2 py-2 text-center text-sm font-medium text-gray-800 bg-gray-200 cursor-pointer relative"
                    ...
                    <div class="flex justify-between items-center">
                        <span class="flex-1">mqtt_name</span>
        ...
        <tbody>
            <template v-if="!storesStore.stores.storesLoading">
                <RouterLink v-for="store in sortedStores" :key="store.id_store" :to="'/stores/' + store.id_store"
