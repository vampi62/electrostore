void handleMenuUser(AsyncWebServerRequest *request)
{
  ...
  response += "<title>User Settings</title>";
  response += "<style>";
  ...
  response += "<h1>User Settings</h1>";
  response += "<div id='notification'></div>";
  response += "<div class='form-container'>";
  response += "  <div class='form-group'>";
  response += "    <input type='checkbox' id='toggleESPPassword' onchange='toggleESPPasswordField()' " + String((espUser.length() > 0 && espPassword.length() > 0 ? "checked" : "")) + "> Enable authentication";
  response += "  </div>";
  response += "  <div class='form-group'>";
  ...
  response += "  </div>";
  response += "  <div class='form-group'>";
  response += "    <label for='espPassword'>Password:</label>";
  ...
  response += "  </div>";
  response += "  <div class='form-group'>";
  response += "    <label for='espConfirmPassword'>Confirm Password:</label>";
  ...
  response += "    <div id='passwordError' style='color: red; display: none;'>Passwords do not match.</div>";
  response += "  </div>";
  response += "  <button id='saveButton' onclick='saveUserSettings()'>Save</button>";
  response += "</div>";
