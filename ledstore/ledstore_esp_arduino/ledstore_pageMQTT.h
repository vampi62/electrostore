void handleMenuMqtt(AsyncWebServerRequest *request)
{
  ...
  response += "<title>Paramètres Mqtt</title>";
  response += "<style>";
  ...
  response += "  </div>";
  response += "  <div class='form-group'>";
  response += "    <input type='checkbox' id='toggleMqttPassword' onchange='toggleMqttPasswordField()' " + String((mqttPassword.length() > 0 ? "checked" : "")) + "> Mot de passe requis";
  response += "  </div>";
  response += "  <div class='form-group'>";
  response += "    <label for='mqttPassword'>Mot de passe:</label>";
  ...
  response += "  </div>";
  response += "  <button onclick='saveMqttSettings()'>Enregistrer</button>";
  response += "</div>";
  response += "<a href='/'>Retour</a>";
  response += "<div class='info'>";
  response += "<b>Version ScanBox:</b> " + String(version_ledstore) + "<br>";
